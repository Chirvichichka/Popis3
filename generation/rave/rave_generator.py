...
class RaveGenerator:
    ...
    def add_text(self, text):
        with open(os.path.join(self._BASE_DIR, "data", "rave.txt"), 'a', encoding='utf-8') as f:
    ...
    def update_model(self):
        ...
        with open(os.path.join(self._BASE_DIR, "data", "interpolated_model.json"), "w", encoding="utf-8") as f:
    ...
    def get_model(self):
        try:
            with open(os.path.join(self._BASE_DIR, "data", "interpolated_model.json"), "r", encoding="utf-8") as file:
    ...
    def get_tokens(self):
        try:
            with open(os.path.join(self._BASE_DIR, "data", "rave.txt"), "r", encoding="utf-8") as file:
